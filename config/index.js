module.exports = {
  ...
  siteTitle : 'Lawns Matter Professional Lawn Care Service', // Navigation and
                                                             // Site Title
  siteTitleAlt :
      'lawnsmatter.co.uk - Lawn Care Service', // Alternative Site title for SEO
  siteTitleShort : 'lawnsmatter.co.uk',        // short_name for manifest
  siteHeadline :
      'Professional Lawn Care Service based in Oxfordshire', // Headline for
                                                             // schema.org
                                                             // JSONLD
  siteUrl :
      'https://lawnsmatter.co.uk', // Domain of your site. No trailing slash!
