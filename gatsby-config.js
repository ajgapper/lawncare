...
module.exports = {
  ...
  plugins: [
    ...
    //   options: {
    //     places: [`www.facebook.com/lawnsmatter`], // Can be either a numeric
    //     ID or the URL ID
    //     params: {
    //       fields: 'lawnsmatter/feed/?fields=id,picture,story,likes', // See
    //       Facebooks API to see what you can query for
    //     },
    //     key:
    ...
    //     // You will need to create a Facebook application and go through
    //     review in order to get an API token.
    //     version: '5.0', // The version of the graph API to use. Defaults
    //     to 5.0
    //   },
    // },
